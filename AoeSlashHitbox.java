...
public class AoeSlashHitbox extends Actor {
    private Character owner;
    private int damage;
    private int duration;
    private List<Actor> hitTargets;

    public AoeSlashHitbox(Character owner, int damage, int duration) {
        this.owner = owner;
        this.damage = damage;
