...
public class Renshiro extends Character implements Movable, Attackable, Rewardable, RangedUnit {
    ...
    public Renshiro(boolean facingRight) {
        ...
        try {
            GreenfootSound spawnSound = new GreenfootSound("Renshiro_spawn.wav");
    ...
    public void die() {
        try {
            GreenfootSound dieSound = new GreenfootSound("Renshirodie.wav");
        ...
        switch (currentState) {
            ...
            case ATTACKING:
                if (attackFrame == currentAttackHitFrame && !attackHasHit) {
                    ...
                    try {
                        GreenfootSound attackSound = new GreenfootSound("Renshiro-Attack.wav");
