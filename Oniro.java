...
public class Oniro extends Character implements Movable, Attackable, Rewardable, MeleeUnit {
    ...
    private static final int MAX_HEALTH = 150, ATTACK_DAMAGE = 35;
    private static final double ATTACK_SPEED_SECONDS = 1.3;
    private static final int ATTACK_RANGE = 50, MOVE_SPEED = 1, REWARD_VALUE = 20;
    ...
    public Oniro(boolean facingRight) {
        ...
        idleSprites = SpriteLoader.loadSprites("dark/oniro_idle.png", 5);
        runSprites = SpriteLoader.loadSprites("dark/oniro_run.png", 8);
        dieSprites = SpriteLoader.loadSprites("dark/oniro_die.png", 6);
        attack1Sprites = SpriteLoader.loadSprites("dark/oniro_attack1.png", 4);
        attack2Sprites = SpriteLoader.loadSprites("dark/oniro_attack2.png", 3);
    ...
    private void setupAttack() {
        ...
        if (currentAttackSprites != null && currentAttackHitFrame >= currentAttackSprites.length) {
             System.out.println("!!! WARNING ONIRO: HitFrame (" + currentAttackHitFrame + ") invalid for attack (" + currentAttackSprites.length + " frames) !!!");
     ...
     private Character findTarget() {
        ...
        for (Character potentialTarget : charactersInRange) {
            if (potentialTarget != null && potentialTarget.getWorld() != null &&
                ...
                isEnemyFaction(potentialTarget)) { // Memanggil isEnemyFaction yang baru
