...
public class Kitsune extends Character implements Movable, Attackable, Rewardable, RangedUnit {
    ...
    private static final int REWARD_VALUE = 15;
    ...
    public Kitsune(boolean facingRight) {
        ...
        idleSprites = SpriteLoader.loadSprites("dark/kitsune_idle.png", 8);
        runSprites = SpriteLoader.loadSprites("dark/kitsune_run.png", 8);
        dieSprites = SpriteLoader.loadSprites("dark/kitsune_die.png", 10);
        attackSprites = SpriteLoader.loadSprites("dark/kitsune_attack.png", 7);
    ...
    private void setupAttack() {
        ...
        if (currentAttackSprites != null && currentAttackHitFrame >= currentAttackSprites.length) {
             System.out.println("!!! WARNING KITSUNE: HitFrame invalid !!!");
    ...
    /**
     * Memeriksa apakah 'target' adalah musuh (berasal dari faksi Light).
     * @param target Karakter yang akan diperiksa.
     * @return true jika target adalah unit Light, false jika bukan.
     */
    ...
    /**
     * Mencari target musuh terdekat dari faksi lawan dalam jangkauan.
     * @return Character musuh terdekat, atau null jika tidak ada.
     */
    ...
    /**
     * Implementasi dari RangedUnit.
     * Memunculkan proyektil KitsuneFire.
     */
    @Override
    public void shootProjectile(Character target) {
        ...
        KitsuneFire projectile = new KitsuneFire(this, projectileSpeed, this.attackDamage);
