...
public class RenshiroArrow extends Projectile {

    public RenshiroArrow(Character owner, int speed, int damage) {
        super(owner, speed, damage);

        GreenfootImage arrowImage = new GreenfootImage("light/renshiro_arrow.png"); 
