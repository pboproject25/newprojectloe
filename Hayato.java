...
public class Hayato extends Character implements Movable, Attackable, Rewardable, MeleeUnit {
    ...
    private static final int ATTACK_RANGE = 55, MOVE_SPEED = 2, REWARD_VALUE = 20;
    ...
    private void setupAttack() {
        ...
        if (currentAttackHitFrame >= currentAttackSprites.length) {
    ...
    private void performAction() {
        switch (currentState) {
            ...
            case ATTACKING:
                ...
                break;
            case DYING:
                if (dieFrame >= dieSprites.length - 1) {
