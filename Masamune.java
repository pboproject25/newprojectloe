...
public class Masamune extends Character implements Movable, Attackable, Rewardable, MeleeUnit {
    ...
    private int idleFrame = 0, idleFrameDelay = 10, idleFrameCounter = 0;
    ...
    public Masamune(boolean facingRight) {
        ...
        idleSprites = SpriteLoader.loadSprites("dark/masamune_idle.png", 5);
        runSprites = SpriteLoader.loadSprites("dark/masamune_run.png", 9);
        dieSprites = SpriteLoader.loadSprites("dark/masamune_die.png", 6);
        attackSprites = SpriteLoader.loadSprites("dark/masamune_attack.png", 5);
    ...
    private void setupAttack() {
        ...
        if (currentAttackSprites != null && currentAttackHitFrame >= currentAttackSprites.length) {
             System.out.println("!!! WARNING MASAMUNE: HitFrame (" + currentAttackHitFrame + ") invalid (" + currentAttackSprites.length + " frames) !!!");
